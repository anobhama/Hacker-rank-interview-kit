...
DoublyLinkedListNode* reverse(DoublyLinkedListNode* head) {
    ...
    DoublyLinkedListNode *head_two = new DoublyLinkedListNode(head->data);
    while (temp->next != nullptr)
    {
        temp = temp->next;
        DoublyLinkedListNode *new_node = new DoublyLinkedListNode(temp->data);
        head_two->prev = new_node;
